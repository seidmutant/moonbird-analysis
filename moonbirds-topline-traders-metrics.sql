WITH nft_trades AS (
    ...
    WHERE
        ...
        -- mint compelted @ 2022-04-16 19:00
...
SELECT
    AVG(total_flip_profit) AS avg_profit_per_trader,
    AVG(total_flip_tokens) AS avg_flip_tokens,
    AVG(avg_selling_time)  AS avg_selling_time
FROM trade_metrics
